/*
    ...
    */
    message = {
        ...
        empty           : 'Please enter something here.',
    ...
    */
    tests = {
        ...
        name : function(a, skip){
            ...
            var expression = /^[a-zA-Z]{3,}(?: [a-zA-Z]+){0,2}$/i;
            try
            {

                if(a.match(expression))
                {
                    // console.log('matched');
                    // console.log(a);
                    return true;
